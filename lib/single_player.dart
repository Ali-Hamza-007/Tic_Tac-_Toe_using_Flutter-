...
class SinglePlayer extends StatefulWidget {
  ...
  const SinglePlayer({super.key, required this.player1, required this.player2});

  @override
  State<SinglePlayer> createState() => _MultiPlayerState();
}

class _MultiPlayerState extends State<SinglePlayer> {
  ...
  int computerGeneratedIndex() {
    Random random = Random();
    int randomNumber = random.nextInt(9);
    return randomNumber;
  }

  void _handleTap(int index, int computerIndex) {
    setState(() {
      ...
      if (board[index] == '') {
        ...
        if (currentPlayer == 'O') {
          while (board[computerIndex] != '') {
            computerIndex = computerGeneratedIndex();
          }
                  ...
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return ElevatedButton(
                        ...
                        onPressed: () {
                          int computerGeneratorIdx = computerGeneratedIndex();
                          _handleTap(index, computerGeneratorIdx);
                        },
                        child: Text(
                          board[index],
                          style: const TextStyle(
